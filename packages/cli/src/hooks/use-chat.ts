...
import { chatStreamEventSchema, type SupportedChatModelId } from '@sora/shared';
...
export type ClientMessagePart =
  { type: 'reasoning'; text: string } | { type: 'text'; text: string } | ClientToolCallPart;
...
export function useChat(sessionId: string, initialMessages: Message[] = []) {
  ...
  const runStream = useCallback(
    ...
    [handleStream, isActiveRequest, updateMessages, clearStream],
  );
